...
const { getAppointments, getAppointment, createAppointment, updateAppointment, deleteAppointment, getCalendarAppointments } = require('../controllers/appointmentController');
